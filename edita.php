...
<html>
	...
	?>
		...
		<form name="f_edita" method="post" action="editado.php">
		
		<label>Id </label><input type="text" size="5" name="f_id"><label> Nome </label><input type="text" size="20" name="f_nome"><label> Descrição </label><input type="text" size="40" name="f_desc">  <label> Preço </label><input type="text" size="7" name="f_preco"> 
		<br/><br/>
